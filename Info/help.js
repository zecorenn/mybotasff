...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        .setDescription(`Hey there I'm ${client.user.username}, by mink. my prefix is **\`${config.Prefix}\`** and **ping me if you forget the prefix**, if you want to get the list of commands then react to emojis that I have already reacted so yeah lets gets started !!`)
        ...
        .addField(`${emoji.Link} Useful Links`, `[Add Me](${config.Invite}) | [Join Server](${config.Server}) | minko asf `)
        .setTimestamp()
